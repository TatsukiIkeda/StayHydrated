...
class CityList {
    ...
    init() {
        list.append(CityModel(cityCode: "011000", cityName: "稚内"))//道北
        ...
        list.append(CityModel(cityCode: "140010", cityName: "横浜"))//神奈川県
        list.append(CityModel(cityCode: "140020", cityName: "小田原"))
        list.append(CityModel(cityCode: "150010", cityName: "新潟"))//新潟県
        list.append(CityModel(cityCode: "150030", cityName: "高田"))
        list.append(CityModel(cityCode: "160010", cityName: "富山"))//富山県
        list.append(CityModel(cityCode: "160020", cityName: "伏木"))
        list.append(CityModel(cityCode: "170010", cityName: "金沢"))//石川県
        list.append(CityModel(cityCode: "170020", cityName: "輪島"))
        list.append(CityModel(cityCode: "180010", cityName: "福井"))//福井県
        list.append(CityModel(cityCode: "180020", cityName: "敦賀"))
        list.append(CityModel(cityCode: "190010", cityName: "甲府"))//山梨県
        list.append(CityModel(cityCode: "190020", cityName: "河口湖"))
        list.append(CityModel(cityCode: "200010", cityName: "長野"))//長野県
        list.append(CityModel(cityCode: "200030", cityName: "飯田"))
        list.append(CityModel(cityCode: "210010", cityName: "岐阜"))//岐阜県
        list.append(CityModel(cityCode: "210020", cityName: "高山"))
        list.append(CityModel(cityCode: "220010", cityName: "静岡"))//静岡県
        list.append(CityModel(cityCode: "220030", cityName: "三島"))
        list.append(CityModel(cityCode: "220040", cityName: "浜松"))
        list.append(CityModel(cityCode: "230010", cityName: "名古屋"))//愛知県
        list.append(CityModel(cityCode: "230020", cityName: "豊橋"))
        list.append(CityModel(cityCode: "240010", cityName: "津"))//三重県
        list.append(CityModel(cityCode: "240020", cityName: "尾鷲"))
        list.append(CityModel(cityCode: "250010", cityName: "大津"))//滋賀県
        list.append(CityModel(cityCode: "250020", cityName: "彦根"))
        list.append(CityModel(cityCode: "260010", cityName: "京都"))//京都府
        list.append(CityModel(cityCode: "260020", cityName: "舞鶴"))
        list.append(CityModel(cityCode: "270000", cityName: "大阪"))//大阪府
        list.append(CityModel(cityCode: "280010", cityName: "神戸"))//兵庫県
        list.append(CityModel(cityCode: "280020", cityName: "豊岡"))
        list.append(CityModel(cityCode: "290010", cityName: "奈良"))//奈良県
        list.append(CityModel(cityCode: "290020", cityName: "風屋"))
        list.append(CityModel(cityCode: "300010", cityName: "和歌山"))//和歌山県
        list.append(CityModel(cityCode: "300020", cityName: "潮岬"))
        list.append(CityModel(cityCode: "310010", cityName: "鳥取"))//鳥取県
        list.append(CityModel(cityCode: "310020", cityName: "米子"))
        list.append(CityModel(cityCode: "320010", cityName: "松江"))//島根県
        list.append(CityModel(cityCode: "320020", cityName: "浜田"))
        list.append(CityModel(cityCode: "320030", cityName: "西郷"))
        list.append(CityModel(cityCode: "330010", cityName: "岡山"))//岡山県
        list.append(CityModel(cityCode: "330020", cityName: "津山"))
        list.append(CityModel(cityCode: "340010", cityName: "広島"))//広島県
        list.append(CityModel(cityCode: "340020", cityName: "庄原"))
        list.append(CityModel(cityCode: "350010", cityName: "下関"))//山口県
        ...
        list.append(CityModel(cityCode: "360010", cityName: "徳島"))//徳島県
        list.append(CityModel(cityCode: "360020", cityName: "日和佐"))
        list.append(CityModel(cityCode: "370000", cityName: "高松"))//香川県
        list.append(CityModel(cityCode: "380010", cityName: "松山"))//愛媛県
        list.append(CityModel(cityCode: "380020", cityName: "新居浜"))
        list.append(CityModel(cityCode: "380030", cityName: "宇和島"))
        list.append(CityModel(cityCode: "390010", cityName: "高知"))//高知県
        list.append(CityModel(cityCode: "390020", cityName: "室戸岬"))
        list.append(CityModel(cityCode: "390030", cityName: "清水"))
        list.append(CityModel(cityCode: "400010", cityName: "福岡"))//福岡県
        ...
        list.append(CityModel(cityCode: "410010", cityName: "佐賀"))//佐賀県
        list.append(CityModel(cityCode: "410020", cityName: "伊万里"))
        list.append(CityModel(cityCode: "420010", cityName: "長崎"))//長崎県
        ...
        list.append(CityModel(cityCode: "440010", cityName: "大分"))//大分県
        ...
        list.append(CityModel(cityCode: "430010", cityName: "熊本"))//熊本県
        ...
        list.append(CityModel(cityCode: "450010", cityName: "宮崎"))//宮崎県
        ...
        list.append(CityModel(cityCode: "460010", cityName: "鹿児島"))//鹿児島県
        ...
        list.append(CityModel(cityCode: "471010", cityName: "那覇"))//沖縄県
